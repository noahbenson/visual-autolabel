...
from .. import (
    nyu_features as features,
    nyu_input_properties as input_properties,
    nyu_output_properties as output_properties)
from ... import (
    train_until,
    load_training,
    autolog)
from ...image._nyu import make_dataloaders as nyu_make_dataloaders


# Commandline Arguments.........................................................
# There must be three of them.
if len(sys.argv) != 5:
    print("SYNTAX: python -m visual_autolabel.benson2024.train_nyu \\\n"
...
train_until(
    inputs, outputs, plan,
    dataloaders=nyu_make_dataloaders,
    model_key=model_key,
    init_weights=weights_filename,
    features=features,
    logger=log,
    raters=None,
    **opts
